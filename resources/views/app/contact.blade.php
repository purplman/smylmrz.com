            ...
            <div class="mt-5">
                <form class="form" action="">
                    ...
                    <div class="form__row">
                        ...
                        <x-app.form-box type="text" name="company_name" required="{{ false }}" placeholder="Your company name">
                            Subject
                        </x-app.form-box>
                        <x-app.form-box type="email" name="email" required="true" placeholder="Your email">
                            Email
                    ...
                    <div class="form__box">
                        ...
                        <textarea maxlength="300" name="project_details" class="form__textarea" placeholder="Tell us about your project" rows="10"></textarea>
                    </div>
